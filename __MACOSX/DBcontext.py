...
# df = pd.read_excel('C:\\Users\\Admin\\Desktop\\task02\\input.xlsx', sheet_name='MAU', usecols='A:H', skiprows=10, nrows=52)
# data = []
...
val = (53, "c200454", "Phi", "dep try", "18/5/2002",2.22,2.25,2.66)
